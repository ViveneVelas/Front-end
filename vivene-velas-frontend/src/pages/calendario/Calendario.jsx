...
function Calendario() {
  ...
  const handleEventDelete = (eventId) => {
    ...
    axios.delete('http://44.204.200.174/pedidos/' + eventId, {
      headers: {
  ...
  const handleEventUpdate = (updatedEvent) => {
    axios.delete('http://44.204.200.174/pedidos/' + updatedEvent, {
      headers: {
        'accept': 'application/json'
      }
    });
  ...
  useEffect(() => {
    ...
    const fetchPedidos = async () => {
      ...
      try {
        const response = await axios.get('http://44.204.200.174/pedidos/calendario', {
          headers: {
            'accept': 'application/json'
          }
        });
