...
const Vela = () => {
    ...
    const fetchData = async (orderBy) => {
        ...
        try {
            const response = await axios.get(`http://44.204.200.174:8080/velas/filtro/${orderBy}`, {
                headers: {
                    'accept': '*/*',
                }
            });
    ...
    const fetchByName = async (name) => {
        setLoading(true); // Ativa o carregamento antes da requisição
        try {
            const response = await axios.get(`http://44.204.200.174:8080/velas/filtro-nome/${name}`, {
                headers: {
                    'accept': '*/*',
                }
            });
