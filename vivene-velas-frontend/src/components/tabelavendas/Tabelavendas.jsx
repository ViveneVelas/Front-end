...
const Tabelavendas = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const velaResponse = await axios.get('http://44.204.200.174/clientes/clientes-mais-compras', {
          headers: { 'accept': '*/*' },
        });
  ...
  const downloadTXT = async () => {
    try {
      const response = await axios.post(
        'http://44.204.200.174/clientes/arq-criar/clientes-mais-compras',
        null,
        {
  ...
  const uploadArquivo = async () => {
    ...
    try {
      ...
      reader.onload = async () => {
        ...
        const response = await axios.post(
          'http://44.204.200.174/clientes/arq-ler/clientes-mais-compras',
