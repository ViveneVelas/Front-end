...
const Grafico = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const metaResponse = await axios.get('http://44.204.200.174/metas/ultima-meta', {
        headers: {
          'accept': '*/*',
        },
      });

      const vendaResponse = await axios.get('http://44.204.200.174/pedidos/quantidade-vendas', {
        headers: {
          'accept': '*/*',
        },
      });
